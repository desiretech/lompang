...
###### Groups
Equivalent of rooms or channels in standard pubsub terminology. A Group can contain a mixture of Posts and Users. Subscribed to a Group via the join or listen method, a User receives Users and Posts packets via the socketReceivedDict delegate method.
